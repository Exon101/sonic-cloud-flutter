...
class MockData {
  ...
  static const cloudDrives = <CloudDrive>[
    CloudDrive(
      id: 'd1',
      name: 'Google Drive',
      description: 'High-Res Audio Library',
      kind: CloudDriveKind.googleDrive,
      streamMode: true,
    ),
    CloudDrive(
      id: 'd2',
      name: 'Dropbox',
      description: 'DJ Mixes & Stems',
      kind: CloudDriveKind.dropbox,
